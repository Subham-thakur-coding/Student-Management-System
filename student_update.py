...
class Update_all_Details:
    ...
    def update_all(self):
        ...
        print(f"Student's Active Status: {response[8]}")
        print("-"*40)
        ...
        con.commit()
        add_audit_log("STUDENT UPDATE",f"{student_id} student id, details updated into database")
        try:
...
Obj_update_student_details = Update_all_Details()